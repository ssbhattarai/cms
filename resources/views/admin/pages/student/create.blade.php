...
<div class="content-wrapper">
        ...
        <div class="offset-sm-1 col-sm-5">
            ...
            <select class="js-example-basic-single form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name" style="width: 100%">
                  <option value>Select Name</option>
                    ...
                    <option @if( old('name') == $user->name) {{ 'selected' }} @endif>{{ $user->name }}</option>
                  @endforeach
                  </select>
              ...
              <div class="form-group">
                ...
                <select class="js-example-basic-single form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" name="email" style="width: 100%">
                  <option value>Select Name</option>
                    @foreach ($users as $user)
                    <option @if( old('email') == $user->email) {{ 'selected' }} @endif>{{ $user->email }}</option>
                  @endforeach
                </select>
                <small class="form-text text-muted">You Must Create a Student Login ID First</small>
              ...
              <input type="text" class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" id="phone" placeholder="Enter Phone" name="phone_number" value="{{ old('phone_number')}}">
              ...
              <input type="text" class="form-control {{ $errors->has('permanent_full_address') ? 'is-invalid' : '' }}" id="peraddress" placeholder="Enter Full Address" name="permanent_full_address" value= "{{ old('permanent_full_address') }}">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control {{ $errors->has('current_full_address') ? 'is-invalid' : '' }}" id="curaddress" placeholder="Enter Full Address" name="current_full_address" value= "{{ old('current_full_address') }}">
      ...
      @endif
            ...
            <div class="form-group">
                ...
                <select class="js-example-basic-single form-control {{ $errors->has('religion') ? 'is-invalid' : '' }}" name="religion" style="width: 100%">
                  <option value>Select religion</option>
                    ...
                    <option value="Others" @if( old('religion') == "Others") {{ 'selected' }} @endif>Others</option>
                  </select>
              ...
              <div class="form-group">
                ...
                <select class="js-example-basic-single form-control {{ $errors->has('cast') ? 'is-invalid' : '' }}" name="cast" style="width: 100%">
                  <option value>Select cast</option>
                    <option value="Brahmin" @if( old('cast') == "Brahmin") {{ 'selected' }} @endif>Brahmin</option>
                    <option value="Chhetri" @if( old('cast') == "Chhetri") {{ 'selected' }} @endif>Chhetri</option>
                    <option value="Janajati" @if( old('cast') == "Janajati") {{ 'selected' }} @endif>Janajati</option>
                    <option value="Others" @if( old('cast') == "Others") {{ 'selected' }} @endif>Others</option>
                  </select>
                @if ($errors->has('cast'))
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('passed_college_name') ? 'is-invalid' : '' }}" id="college_name" placeholder="Enter College Name" name="passed_college_name" value= "{{ old('passed_college_name') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->has('passed_year') ? 'is-invalid' : '' }}" id="passedyear" placeholder="Passed Year" name="passed_year" value= "{{ old('passed_year') }}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control {{ $errors->has('marks_obtain') ? 'is-invalid' : '' }}" id="obtainedMarks" placeholder="Enter Marks" name="marks_obtain" value= "{{ old('marks_obtain') }}">
